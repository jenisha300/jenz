      ...
      <div data-aos="fade-up" data-aos-duration="300" className="py-0">
        <div className="container">
          <div className="text-center mb-10 max-w-[400px] mx-auto">
            <p className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary text-[25px]">
              What our customers say
            </p>
            <h1 className="text-[50px] font-[poppind] font-bold">Testimonial</h1>
            <p className="text-xs text-gray-60000">
